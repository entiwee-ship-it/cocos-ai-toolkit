...
The extension is loaded through the project's `extensions/cocos-ai-bridge` junction and stays aligned with the MCP Server, Probe Server, and Bridge build in the fixed runtime worktree.
